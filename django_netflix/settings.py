...
AWS_ACCESS_KEY_ID = os.getenv("AWS_ACCESS_KEY_ID_my")
AWS_SECRET_ACCESS_KEY = os.getenv("AWS_SECRET_ACCESS_KEY_my")
AWS_STORAGE_BUCKET_NAME = os.getenv("AWS_STORAGE_BUCKET_NAME_my")
